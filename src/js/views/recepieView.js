...
class RecipeView extends View {
  ...
  _errorMessage = 'we could not find the recipe ,Please find another one.';
  _message = '';
  addHandlerAddBookmark(handler) {
    this._parentEl.addEventListener('click', function (e) {
      // we use the event delegation becuase btn--bookmark does not exist at the time of page start.
